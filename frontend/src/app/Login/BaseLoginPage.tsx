...
import {backendApi, createApi} from "@app/utils/axios-config";


export const BaseLoginPage = ({setAuthenticated}) => {
  ...
  const onLoginButtonClick = (event: React.MouseEvent<HTMLButtonElement, MouseEvent>) => {
    ...
    backendApi.post('/auth/login', {
      ...
      console.log('wanna redirect', role, role === 'ADMIN')
      if (role === 'ADMIN') {
